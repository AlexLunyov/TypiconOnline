        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleSettingsId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypiconClaimDescriptionItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypiconClaimNameItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypiconDescriptionItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypiconNameItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sign_PrintDayTemplate_PrintDayTemplateId",
                        column: x => x.PrintDayTemplateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutputDay_PrintDayTemplate_PrintDayTemplateId",
                        column: x => x.PrintDayTemplateId,
                        principalTable: "PrintDayTemplate",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignSchedule", x => new { x.ScheduleSettingsId, x.SignId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SignSchedule_Sign_SignId",
                        column: x => x.SignId,
                        principalTable: "Sign",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutputDay_PrintDayTemplateId",
                table: "OutputDay",
                column: "PrintDayTemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sign_PrintDayTemplateId",
                table: "Sign",
                column: "PrintDayTemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypiconClaimDescriptionItems_DescriptionId",
                table: "TypiconClaimDescriptionItems",
                column: "DescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_TypiconClaimNameItems_NameId",
                table: "TypiconClaimNameItems",
                column: "NameId");

            migrationBuilder.CreateIndex(
                name: "IX_TypiconDescriptionItems_DescriptionId",
                table: "TypiconDescriptionItems",
                column: "DescriptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypiconNameItems_NameId",
                table: "TypiconNameItems",
                column: "NameId");
