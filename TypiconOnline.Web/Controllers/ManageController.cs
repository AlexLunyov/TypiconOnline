...
using TypiconOnline.Web.Models.ManageViewModels;
...
namespace TypiconOnline.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private readonly IJobRepository _queue;
        ...
        {
            return View(new ReloadRulesModel());
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ReloadRules(int id)
        {
            _queue.Create(new ReloadRulesJob(id, TypiconVersionStatus.Published));

            return View(new ReloadRulesModel() { StatusMessage = "Заявка на обновление правил отправлена." });
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("TypiconOnline.Web"),
