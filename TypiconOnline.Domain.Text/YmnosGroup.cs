...
namespace TypiconOnline.Domain.Rules.Days
{
    ...
    public class YmnosGroup : DayElementBase, IContainingIhos
    {
        ...
        /// Тип группы
        /// </summary>
        [XmlAttribute(XmlConstants.YmnosGroupKindAttrName)]
        ...
        protected override void Validate()
        {
            ...
            {
                AppendAllBrokenConstraints(Prosomoion, XmlConstants.ProsomoionNode);
            }

            if (Annotation?.IsValid == false)
            {
                AppendAllBrokenConstraints(Annotation, XmlConstants.AnnotationNode);
            }
            ...
            foreach (Ymnos ymnos in Ymnis)
            {
                if (!ymnos.IsValid)
                {
                    AppendAllBrokenConstraints(ymnos, XmlConstants.YmnosNode);
                }
            }
        }
