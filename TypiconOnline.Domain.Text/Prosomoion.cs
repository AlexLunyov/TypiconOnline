...
namespace TypiconOnline.Domain.Rules.Days
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot(ElementName = XmlConstants.ProsomoionNode)]
    public class Prosomoion : ItemText
    {
        ...
        /// </summary>
        [XmlAttribute(XmlConstants.ProsomoionSelfAttr)]
        ...
        //{
        //    if (reader.MoveToAttribute(XmlConstants.ProsomoionSelfAttr))
        //    {
        ...
        //    if (Self)
        //    {
        //        writer.WriteAttributeString(XmlConstants.ProsomoionSelfAttr, Self.ToString());
        //    }
