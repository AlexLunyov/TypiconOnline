...
{
    public abstract class RuleModelValidatorBase<T> : RuleSerializerModelValidatorBase<T> where T: class, new()
    {
        public RuleModelValidatorBase(IRuleSerializerRoot ruleSerializer) : base(ruleSerializer) { }
