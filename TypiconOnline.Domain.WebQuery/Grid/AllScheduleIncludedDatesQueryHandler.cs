...
namespace TypiconOnline.Domain.WebQuery.Grid
{
    ...
    /// 
    /// </summary>
    public class AllScheduleIncludedDatesQueryHandler : WebDbContextQueryBase, IQueryHandler<AllScheduleIncludedDatesQuery, Result<IQueryable<DateGridItem>>>
    {
        public AllScheduleIncludedDatesQueryHandler(WebDbContext dbContext) : base(dbContext)
        {
