        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(nullable: false),
                    RoleId2 = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityUserRole<int>_Role_RoleId2",
                        column: x => x.RoleId2,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IdentityUserRole<int>_User_UserId2",
                        column: x => x.UserId2,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TypiconEntity_User_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OutputForm_TypiconEntity_TypiconId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentityUserRole<int>_RoleId2",
                table: "IdentityUserRole<int>",
                column: "RoleId2");

            migrationBuilder.CreateIndex(
                name: "IX_IdentityUserRole<int>_UserId2",
                table: "IdentityUserRole<int>",
                column: "UserId2");
