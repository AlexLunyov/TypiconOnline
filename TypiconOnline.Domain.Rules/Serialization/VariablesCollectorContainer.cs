...
{
    public class VariablesCollectorContainer<T> : IRuleSerializerContainer<T> where T : IRuleElement
    {
        private readonly IRuleSerializerContainer<T> _innerContainer;
        private readonly VariablesCollectorSerializerRoot _serializerRoot;

        public VariablesCollectorContainer(IRuleSerializerContainer<T> container, VariablesCollectorSerializerRoot serializerRoot)
        {
