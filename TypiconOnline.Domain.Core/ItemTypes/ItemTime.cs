    ...
    public class ItemTime : ItemType
    {
        ...
        public string Expression
        {
            ...
            set
            {
                ...
                if (DateTime.TryParseExact(_stringExpression, CommonConstants.ItemTimeParsing, new CultureInfo("ru-RU"), DateTimeStyles.None, out date))
                {
                    Hour = date.Hour;
                    Minute = date.Minute;
                }
        ...
        protected override void Validate()
        {
            ...
            {
                DateTime date = new DateTime();
                if (!DateTime.TryParseExact(this.ToString(), CommonConstants.ItemTimeParsing, new CultureInfo("ru-RU"), DateTimeStyles.None, out date))
                {
