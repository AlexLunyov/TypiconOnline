...
namespace TypiconOnline.Domain.Versioned.Typicon.Variable
{
    public class TypiconVariable //: ITypiconVersionChild
    {
        ...
        public virtual List<VariableModRuleLink<SignVersion>> SignLinks { get; set; } = new List<VariableModRuleLink<SignVersion>>();
        ...
        public void AddLink<T>(T entity, DefinitionType definitionType = DefinitionType.Rule) where T : VersionBase//, new()
        {
            ...
            {
                SignLinks.Add(new VariableModRuleLink<SignVersion>()
                {
                    Variable = this,
                    Entity = entity as SignVersion,
