...
{
    public class VersionedDbContextFactory
    {
        public static VersionedContext Create()
        {
            return new VersionedContext(GetOptions());
        }

        private static DbContextOptions<VersionedContext> GetOptions()
        {
